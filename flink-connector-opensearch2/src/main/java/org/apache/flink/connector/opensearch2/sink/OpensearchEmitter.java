 ...
 *
 * <pre>{@code
 * private static class TestOpensearchEmitter implements OpensearchEmitter<Tuple2<Integer, String>> {
 *
 ...
 * }</pre>
 *
 * @param <T> The type of the element handled by this {@link OpensearchEmitter}
 */
@PublicEvolving
